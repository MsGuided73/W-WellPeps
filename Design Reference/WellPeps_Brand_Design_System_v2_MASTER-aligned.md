...
| **Primary / working blue** | `#1565C0` (muted) | **`#0B5CEF`** — the brighter, more saturated royal blue used for CTAs, links, and accent words in the approved mockups |
| **Accent words in headlines** | (n/a) | Same vivid `#0B5CEF` (e.g. "Simplified.", "WellPeps", "Come First") |
...
| Program card tagline | **Lora** *italic* | 500 | Vivid blue (`#0B5CEF`), e.g. "Feel Your Best". |
...
| **Working Blue** | `#0B5CEF` | **Primary CTAs, links, active states, accent words** |
| Working Blue (hover) | `#0A49C9` | Button/link hover |
...
- **Buttons** — Primary: solid `#0B5CEF`, white text, soft blue shadow, lift on
  hover. Secondary: white with 2px `#0B5CEF` border, inverts on hover.
  Radius 10px.
